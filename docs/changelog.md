...
- Reorganized official site and documentation navigation to match the public
  concept tree: JSON Document, Editing, and Connectors. Concepts is the
  overall map; Selection, History, and Clipboard are Editing guides;
  Topology moved under Editing; demos hang under their concept.
