...
const publicDocs = {
  ...
  domains: read("docs/public/domains.md"),
  domainSchema: read("docs/public/domain-schema.md"),
  domainDocument: read("docs/public/domain-document.md"),
  domainOrder: read("docs/public/domain-order.md"),
  domainObject: read("docs/public/domain-object.md"),
  domainSheet: read("docs/public/domain-sheet.md"),
  domainTree: read("docs/public/domain-tree.md"),
  domainKanban: read("docs/public/domain-kanban.md"),
  domainDatabase: read("docs/public/domain-database.md"),
  domainRichText: read("docs/public/domain-rich-text.md"),
