...
const publicDocs = {
  ...
  chat: read("docs/public/chat.md"),
  agent: read("docs/public/agent.md"),
  code: read("docs/public/code.md"),
  slides: read("docs/public/slides.md"),
  calendar: read("docs/public/calendar.md"),
  form: read("docs/public/form.md"),
};
const surfaces = {
