...
if (tsconfigPathAliases["@interactive-os/json-document/react"]?.[0] !== "packages/json-document/src/public/react.ts") {
  fail("tsconfig.json-document-paths.json: missing @interactive-os/json-document/react source path.");
}
if (tsconfigPathAliases["@interactive-os/json-document"]?.[0] !== "packages/json-document/src/public/index.ts") {
