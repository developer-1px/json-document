...
| archived 1.x 기준선 | [docs/standard/conformance-profile.md](docs/standard/conformance-profile.md) |

## 코드 지도

| 위치 | 역할 |
| --- | --- |
| [packages/json-document](packages/json-document) | v2 Kernel과 archived 1.x source |
