import { type JSONDocument, type JSONPatchOperation, type Pointer, type SelectionPoint, type SelectionRange, trackPointer } from "@interactive-os/json-document/session";
