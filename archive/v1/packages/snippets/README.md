...
using schema-safe public insert checks: block editors, CMS sections, kanban cards,
...
- Allow per-snippet and per-call insert options such as `rekey` and `spread`.
...
- No id generation policy beyond public insert `rekey` options; host code may
