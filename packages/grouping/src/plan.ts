import { appendSegment, type JSONCapabilityResult, type JSONDocument, type JSONPatchOperation, lastSegmentIndex, parentPointer, type Pointer, resolveSiblingRange, type SiblingRangeResult, tryParsePointer } from "@interactive-os/json-document/session";
