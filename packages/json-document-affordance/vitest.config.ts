...
export default defineNodeProject("json-document-affordance", {
  resolve: {
    alias: {
      "@interactive-os/json-document-web": new URL("../json-document-web/src/index.ts", import.meta.url).pathname,
