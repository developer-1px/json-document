...
describe("RichTextRenderer", () => {
  ...
  it("preserves whitespace on the official editable surface without discarding host styles", () => {
    ...
    expect(html).toContain('<p data-rich-text-node-id="empty" data-rich-text-container-id="empty"><span data-rich-text-placeholder="" contentEditable="false" aria-hidden="true">​</span></p>');
