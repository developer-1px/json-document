...
export function ComposerReferenceAtom({ node, editor, ...props }: ComposerReferenceAtomProps): ReactNode {
  const kind = referenceKind(node);
  if (kind === null) return null;
  if (kind === "mention") return <RichTextMentionAtom {...props} node={node} {...(editor === undefined ? {} : { editor })} data-composer-reference-kind="mention" />;
