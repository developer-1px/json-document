...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import type { HistoryTransactionOptions, JSONCapabilityResult, JSONChangeMetadata, JSONDocument, JSONDocumentCommitOptions, JSONDocumentDuplicateError, JSONDocumentDuplicateOptions, JSONDocumentDuplicateResult, JSONDocumentEditError, JSONDocumentEditResult, JSONDocumentHistory, JSONDocumentInsertOptions, JSONDocumentInsertTarget, JSONDocumentMoveTarget, JSONDocumentOptions, JSONDocumentPasteOptions, JSONDocumentPasteTarget, JSONPatchInput, SelectionPoint, JSONResult } from "@interactive-os/json-document";',
