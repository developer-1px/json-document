...
export const ui = {
  ...
  surface: {
    ...
    contentObject: "rounded-control border border-line-subtle/30 bg-background-subtle/80",
    floatingControl: "rounded-full border border-line-subtle/50 bg-background-canvas shadow-surface",
    floatingPanel: "rounded-surface border border-line-subtle/45 bg-background-canvas shadow-overlay",
    scrollEdgeHard: "border-b border-line-subtle/20 bg-background-canvas",
