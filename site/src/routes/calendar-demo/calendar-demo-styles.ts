...
export const calendarDemoRecipe = tv({
  slots: {
    ...
    dayNumber: "inline-flex size-7 items-center justify-center text-sm font-medium text-foreground-strong",
    ...
    hourLabel: "absolute right-2 whitespace-nowrap text-right text-overline tabular-nums leading-none text-foreground-muted/70",
