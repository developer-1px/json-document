...
const chipSelected = "data-[calendar-move-surface=true]:cursor-grab data-[calendar-move-surface=true]:active:cursor-grabbing data-[preview=true]:opacity-60 data-[selected=true]:font-semibold data-[selected=true]:text-foreground-strong data-[selected=true]:shadow-none data-[selected=true]:outline data-[selected=true]:outline-1 data-[selected=true]:-outline-offset-1 data-[selected=true]:outline-line-strong/40 data-[primary=true]:z-10 data-[primary=true]:!outline-2 data-[primary=true]:!-outline-offset-2 data-[primary=true]:!outline-line-strong";
...
export const calendarDemoRecipe = tv({
  slots: {
    ...
    resizeEdge: "absolute z-20 appearance-none border-0 bg-transparent p-0 shadow-none transition-colors after:absolute after:left-1/2 after:top-1/2 after:h-0.5 after:w-8 after:-translate-x-1/2 after:-translate-y-1/2 after:rounded-full after:bg-foreground-muted after:transition-[width,height,background-color] hover:bg-background-accent-subtle/60 hover:after:h-1 hover:after:w-10 hover:after:bg-line-accent data-[active=true]:bg-background-accent-subtle data-[active=true]:after:h-1 data-[active=true]:after:w-10 data-[active=true]:after:bg-line-accent focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-line-accent focus-visible:after:h-1 focus-visible:after:w-10 focus-visible:after:bg-line-accent",
    resizeEdgeVertical: "absolute z-20 appearance-none border-0 bg-transparent p-0 shadow-none transition-colors after:absolute after:left-1/2 after:top-1/2 after:h-3 after:w-0.5 after:-translate-x-1/2 after:-translate-y-1/2 after:rounded-full after:bg-foreground-muted after:transition-[width,height,background-color] hover:bg-background-accent-subtle/60 hover:after:h-4 hover:after:w-1 hover:after:bg-line-accent data-[active=true]:bg-background-accent-subtle data-[active=true]:after:h-4 data-[active=true]:after:w-1 data-[active=true]:after:bg-line-accent focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-line-accent focus-visible:after:h-4 focus-visible:after:w-1 focus-visible:after:bg-line-accent",
