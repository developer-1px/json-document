...
export const calendarDemoRecipe = tv({
  slots: {
    ...
    hourRule: "absolute inset-x-0 border-t border-line-subtle/30",
    ...
    weekCell: "relative border-l border-line-subtle/20",
    ...
    creationTimeHint: "pointer-events-none absolute left-1 z-20 -translate-y-1/2 whitespace-nowrap text-overline tabular-nums leading-none text-foreground-muted",
