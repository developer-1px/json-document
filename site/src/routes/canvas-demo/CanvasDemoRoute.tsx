...
export function CanvasDemoRoute() {
  ...
  return (
    <DemoPage documentation={<PageHeader illustration="peek" title="Canvas">한 장에 글자·도형·스티커 노트·그리기. 도형 안에도 더블클릭으로 글을 적습니다. Shift+클릭으로 다중 선택하고 Alt+드래그로 복제합니다. 스타일 아이콘에서 색·글자 서식·테두리를 바꾸고, 복사한 텍스트·이미지를 붙여넣습니다.</PageHeader>}>
