...
type AdminTask = z.infer<typeof adminTaskSchema>;

const initialTasks: ReadonlyArray<AdminTask> = [
    ...
    <section aria-label="Zod admin" className="grid gap-4">
      <div className="grid gap-1">
        ...
        <p className={classes("m-0", ui.text.meta)}>
          A Zod object schema and record array become a ready-to-use admin. The host owns records; the Hand owns editing behavior.
        </p>
      </div>
      <DatabaseHand
        schema={adminTaskSchema}
        records={tasks}
        ...
        labels={{ ariaLabel: "Admin records" }}
      />
