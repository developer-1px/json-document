      ...
      <div className="mx-auto max-w-6xl">
        <header className="mb-6 grid gap-4 border-b border-stone-200 pb-5 lg:grid-cols-[minmax(0,1fr)_24rem]">
          <div>
            ...
            <h1 className="mb-2 mt-1 text-3xl font-semibold text-stone-950">React Connector</h1>
          ...
          <div className="rounded border border-stone-200 bg-white p-3">
            ...
            <code className="mt-2 block overflow-x-auto text-xs text-stone-700">npm i @interactive-os/json-document-react</code>
          </div>
        </header>

        <ReactConnectorLab />

        <section aria-label="Minimal React connector code" className="mt-4 rounded border border-stone-200 bg-white p-4">
