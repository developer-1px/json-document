...
export const annotationDemoRecipe = tv({
  slots: {
    ...
    commentPreview: "pointer-events-none absolute z-20 w-[280px] rounded-surface border border-line-subtle bg-background-canvas px-3 py-2.5 text-sm leading-5 text-foreground-strong shadow-overlay",
